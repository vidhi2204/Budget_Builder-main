...
//             DataViewModel dataViewModel = new DataViewModel
//             {
//                 MonthList = JsonConvert.DeserializeObject<List<string>>(monthList),
//                 IncomeCategoryList = new List<CategoryViewModel>(),
//                 ExpenseCategoryList = new List<CategoryViewModel>(),
//                 TotalIncome = new List<decimal>(),
//                 TotalExpense = new List<decimal>(),
//                 ProfitLoss = new List<decimal>(),
//                 OpeningBalance = new List<decimal>(),
//                 ClosingBalance = new List<decimal>()
//             };
...
//         catch (Exception ex)
//         {
//             _logger.LogError(ex, "Error generating budget sheet");
//             return StatusCode(500, new { error = "Failed to generate budget sheet", details = ex.Message });
//         }
//     }
//     #endregion

//     // Removed as client-side handles these operations
//     /*
//     #region Update Budget Sheet partial view
//     public IActionResult UpdatePartialView(string DatasheetVM)
//     {
...
//         catch (Exception ex)
//         {
//             _logger.LogError(ex, "Error exporting budget sheet to Excel");
//             return StatusCode(500, new { error = "Failed to export budget sheet", details = ex.Message });
//         }
//     }
//     #endregion
...
//             var result = new FileContentResult(fileData, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
//             {
//                 FileDownloadName = "ActivitySheet.xlsx"
//             };
//             return result;
//         }
//         catch (Exception ex)
//         {
//             _logger.LogError(ex, "Error exporting activity to Excel");
//             return StatusCode(500, new { error = "Failed to export activity sheet", details = ex.Message });
//         }
//     }
//     #endregion
